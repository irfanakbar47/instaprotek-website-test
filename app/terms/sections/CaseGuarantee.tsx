  ...
  return (
    <>
      ...
      <section className="space-y-4 mt-8">
        ...
        <p>
          A claim can be denied if the Eligible Device cannot be repaired and must be replaced. However, if the primary cause of replacement is determined to be related to the Coverage Type and the price of the covered part can be determined from the following website:&nbsp;<a href="https://www.mobilesentrix.com/" target="_blank" rel="noopener noreferrer" className="underline text-blue-600 hover:text-blue-800">https://www.mobilesentrix.com/</a>&nbsp;then the customer will be reimbursed for the cost of the part as specified in said website up to the coverage limit of the policy.
        </p>
