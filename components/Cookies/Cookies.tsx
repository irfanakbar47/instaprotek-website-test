...
const Cookies = () => {
  return (
    <CookieConsent
      ...
      containerClasses="!bg-[#EDF3F9] fixed !left-[20px] !bottom-[20px] !mr-[20px] !w-auto lg:!w-[1080px] rounded-[15px] !z-[999999999] p-[10px] !flex !items-center flex-col md:flex-row "
    ...
    >
      <div className="flex items-center justify-between gap-x-7">
        ...
        <p className="w-auto !font-inter !tracking-normal max-w-[140ch] mr-[20px] md:mr-[90px] lg:mr-[40px] text-left text-blk font-karla">
					We use cookies to ensure you get the best experience on our website. By continuing to browse, you agree to our use of cookies. Want to know more? Check out our <a href="https://instaprotek.com/privacy" className='underline'>Privacy Policy</a>. 
        </p>
      </div>
    </CookieConsent>
  );
